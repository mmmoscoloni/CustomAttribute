...
class EnableFeatureToggleCommand extends Command
{
    ...
    {
        $this->setName('customattribute:feature-toggle:enable')
            ->setDescription('Enable the special attribute feature');
        parent::configure();
    }
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        $this->configWriter->save(self::FEATURE_TOGGLE_PATH, 1);
    
        $this->runUpgrade(1, $output);
    
        $output->writeln('<info>Feature toggle enabled successfully.</info>');
